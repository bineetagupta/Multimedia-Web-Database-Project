...
%writing all magnitude tpgether for each cell in new matrix
...
%final matrix construction- used manhattan distance to compute the
%similarity
for i_new=0:nframes1
    for j_new=0:nframes2
        ...
        for c_new=1:c
            ...
            final_matrix(i_new+1,j_new+1)=dot/16;
     end
end
