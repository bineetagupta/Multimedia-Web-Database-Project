...
%
% Below is a four (4 optional) step process:
...
arrKeyFrameInput = input('Do you want to make a video out of Key Frames (computationally expensive) (y/n): ', 's');
...
for frameIndex=1:(numberOfFrames-1)
    ...
    histFrame1 = entropy(frame);
    histFrame2 = entropy(frameNext);
    
    d=sum(double(num2str(pdist2(histFrame1',histFrame2'))));
