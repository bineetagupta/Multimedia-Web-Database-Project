...
////////////////////////////////////////////////////////////////////////////////////////
std::string video; int videoFrame=0; std::string matchedVideo; int matchedVideoFrame=0; 
float similarity; int row1=0; int column1=0; int f =0 ; float frame;
////////////////////////////////////////////////////////////////////////////////////////

std::map<std::string,int> videoMap;
std::ifstream file3("3b2.csv"); //Hard coded path of csv file 
std::string line3; 
std::string line;
...
std::ifstream file("3b2.csv"); //Hard coded path of csv file
if(file.good())
{
  ...
  ofstream myfile1;
  myfile1.open ("similarity_score_3b.csv");
  
  
	
	for(int i = 0; i < row; i++){
		for(int j = 0; j < row; j++){
			myfile1 <<similarity_score[i][j]<<",";
		}
		cout <<endl;
	}
