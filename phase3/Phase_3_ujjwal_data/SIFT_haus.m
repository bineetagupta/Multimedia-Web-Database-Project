function [dist,corresDistance]=SIFT_haus(fileName,file1,file2)
...
for i=1:nFrames1
    for j=1:nFrames2
        corresDistance(j,i)=sift_hausroff(videoVector1(findex1(i,1)+1:findex1(i+1,1),dStart:dEnd)',videoVector2(findex2(j,1)+1:findex2(j+1,1),dStart:dEnd)');
    end
end
