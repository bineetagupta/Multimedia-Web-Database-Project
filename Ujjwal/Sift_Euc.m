...
%ratio of matched image pairs [0,1]
...
for i=1:nFrames1
    for j=1:nFrames2
        corresDistance(j,i)=sift_euclidian(videoVector1(findex1(i,1)+1:findex1(i+1,1),8:135)',videoVector2(findex2(j,1)+1:findex2(j+1,1),8:135)');
    end
end
